			...
			BetterAPI.npm('discord.js', saveDir, function () {
				...
				bot.on("message", function (message) {
					if (BetterDiscordLogging.events.message) {
						if (debugging) {
							BetterDiscordBot.debug('message', arguments);
						}
					...
					if (BetterDiscordBotting.settings.enabled) {
						...
						var _continue = false;var msgOther = false;var msgOwn = false;
					...
					// if (message.author.id == BetterAPI.getOwnID()) {
						// var msg = message.content.toLowerCase();
						// if(msg == '!explain'){
							// bot.sendMessage(message.channel, 'Uploading GIF avatars was a bug that is fixed since dec 2015. That means you can not set them anymore.');
						...
						// }else if(msg.startsWith('!explain ')){
							// bot.sendMessage(message.channel, msg.split('!explain ')[1]+' Uploading GIF avatars was a bug that is fixed since dec 2015. That means you can not set them anymore.');
							// BetterAPI.sendImage('NoGIFAvatar.GIF', 'data:image/png;base64,', message.channel.id);
						// }else if(msg == '!time'){
							// var now = new Date();bot.sendMessage(message.channel, 'My local time is `' + now + '`');
						// }else if(msg == '!help'){
							// var prefix = '<@' + BetterAPI.getOwnID() + '> ';bot.sendMessage(message.channel, '**BetterDiscordBot** by @Decorater and Bluscream.\n\nPrefix: ' + prefix + '\nCommands:`info`,`time`');
						// }
					// }
					// if (message.author.id != BetterAPI.getOwnID()) {
						// var sendMSG = "";
						...
						// if (BetterDiscordBotting.settings.enabled) {
							...
							// case prefix + 'info':
								...
								// break;
							// case prefix + 'version':
								// sendMSG = "Discord `0.0.287` **|** BetterDiscord `0.2.7` (JS `1.61`) **|** Discord.js `" + require("discord.js/package").version + "` **|** BetterDiscordBot `" + BetterDiscordBot.prototype.getVersion() + "`";
								// break;
							// case prefix + 'ping':
								// if (BetterAPI.elemExists('.voice-connection-quality-fine')) {
								...
								// break;
							// case prefix + 'time':
								// sendMSG = 'My local time is `' + now + '`';
								// break;
							// case prefix + 'finger':
								// sendMSG = 'echo "Ohh, yeah i like that :3"';
								// break;
							// default:
								// break;
							// }
						...
						// if (BetterDiscordBotting.settings.gifavatar) {
							...
							// if (msg.indexOf('profile') !== -1 && msg.indexOf('picture') !== -1&& msg.indexOf('animated') !== -1) { sn = true; }
							// if (msg.indexOf('profile') !== -1 && msg.indexOf('picture') !== -1&& msg.indexOf('gif') !== -1) { sn = true; }
						...
						// if (sendMSG != "") {
							...
							// if (BetterDiscordBotting.settings.debug) {
								// console.log('Sent Message ' + wM(sendMSG) + ' in channel \'' + message.channel.name + '\' on server ' + wS(message.channel.server.name));
							// }
						// }
					// }
				});
