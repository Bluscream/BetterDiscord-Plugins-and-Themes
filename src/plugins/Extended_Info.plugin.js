//META{"name":"userInfo"}*//
function userInfo() {
	this.getName = function(){ return "Extended Info"; }
...
userInfo.prototype.onMessage = function() {};
...
try{exports.userInfo = userInfo;}catch(e){console.warn('Using old version, not exporting functions.')}